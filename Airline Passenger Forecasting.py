...
df = pd.read_csv("C:\\Users\\hazal\\Downloads\\time_series-220912-164609\\time_series\\datasets\\airline-passengers.csv",index_col="month",parse_dates=True)
df.head()
...
# ARIMA (p, d, q): (Autogressive Integrated Moving Average)
